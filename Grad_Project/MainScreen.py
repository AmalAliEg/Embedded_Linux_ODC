...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(resource_path("icons/icons_home.png")))
        ...
        self.cbc_button.setIcon(QIcon(resource_path("icons/iconsr_home.png")))
        ...
        self.cbc_buttontv.setIcon(QIcon(resource_path("icons/icons_tv.png")))
        ...
        self.cbc_button_car.setIcon(QIcon(resource_path("icons/car.png")))
        ...
        self.logo_label.setPixmap(QPixmap(resource_path("icons/LOGO.png")).scaled(120, 120, Qt.KeepAspectRatio))  # Replace "logo.png" with your logo file
