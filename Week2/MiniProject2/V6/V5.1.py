...
class SubWindow(QMainWindow):
    def __init__(self):
        ...
        self.city_combo.setGeometry(20, 250, 320, 40)  # (x, y, العرض, الارتفاع)
        ...
        self.play_button = self.create_toggle_button("Play", "icons_speaker.png", 900, 120)
        self.play_button.clicked.connect(self.toggle_play)

        # زر تكرار الموسيقى
        self.repeat_button = self.create_toggle_button("Repeat", "icons_repeat.png", 900, 220)
        self.repeat_button.clicked.connect(self.toggle_repeat)

      
        self.home_button = self.create_toggle_button("Home", "icons_house.png", 900, 320)
        self.home_button.clicked.connect(self.open_sub_window3)

        # زر العودة إلى النافذة الرئيسية

        self.back_button = self.create_toggle_button("Back", "icons_back.png", 900, 420)
...
class VoiceThread(QThread):
    command_detected = pyqtSignal(str)     #send for the slotes connected to it
...
class SmartControlHub(QMainWindow):
    ...
    def setup_left_panel(self):
        ...
        self.vertical_layout = QVBoxLayout(self.left_panel)           ##the veritical container 
        ...
        self.horizontal_layout.addWidget(self.left_panel)            ##the Horizontal container
        
        #set the layout of the date and day label
    def setup_datetime_section(self):
        ...
        #set the layout of the voice button
    ...
    #timer to send timeout signal each 1 sec
    def setup_datetime(self):
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.update_datetime)
        self.timer.start(1000)
        self.update_datetime()
    #get the current date and day --update infront the labels
    ...
    #start the thread in bg
    def setup_voice_recognition(self):
        self.voice_thread = VoiceThread()
        #connect command_detected with handle_voice_command function
    ...
    #function if the button clicked, it call handle_lights
    def connect_buttons(self):
        #if the true  , call handle_lights
