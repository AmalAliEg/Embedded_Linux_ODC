...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QPushButton, QWidget, QVBoxLayout, QLabel, QLCDNumber, QListWidget, 
,QFileDialog, QSlider, QComboBox, QFrame, QHBox,QGridLayout)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("SmartDash for User Interface using Raspberry Pi.")
...
class SmartControlHub(QMainWindow):
    # SmartControlHub implementation...
    def __init__(self):
        super().__init__()
        self.setWindowFlags(Qt.FramelessWindowHint)
