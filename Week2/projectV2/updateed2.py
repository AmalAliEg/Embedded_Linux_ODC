...
from PyQt5.QtWebEngineWidgets import QWebEngineView  # Import for Google Maps
    ...
    def handle_gps(self, command):
        if command == "on":
            ...
            if not self.maps_widget:
                self.maps_widget = QWebEngineView()
                self.mapsLayout.addWidget(self.maps_widget)
            self.maps_widget.setUrl("https://www.google.com/maps")
