...
class RoomWindow(QMainWindow):
    ...
    # Initialize OpenCV video capture
        ...
        #Back button home
        self.Home_button = self.create_toggle_button("Home", resource_path("icons/icons_back.png"), 20, 20)
...
#---------------------------family----------------------------------
        ...
        self.Floor_button = self.create_toggle_button("Floor", resource_path("icons/icons_led.png"), 220, 20)
        self.dining_room_button = self.create_toggle_button("dining room", resource_path("icons/icons_dining_room.png"), 320, 20)
        self.kitchen_button = self.create_toggle_button("kitchen", resource_path("icons/icons-kitchen.png"), 420, 20)
...
#---------------------------master----------------------------------
        ...
        self.Bedroom_button = self.create_toggle_button("Bedroom", resource_path("icons/icons_bed.png"), 220, 130)
        self.shower_button = self.create_toggle_button("shower", resource_path("icons/icons_shower.png"), 320, 130)
        self.Clothes_room_button = self.create_toggle_button("Clothes", resource_path("icons/icons_womens.png"), 420, 130)
        self.Fan_button = self.create_toggle_button("Fan", resource_path("icons/icons_fan.png"), 520, 130)
...
#---------------------------garage----------------------------------
        ...
        self.garagdoor_button = self.create_toggle_button("Garage Door", resource_path("icons/icons_garage.png"), 220, 240)
        self.led_button = self.create_toggle_button("LED", resource_path("icons/icons_light.png"), 320, 240)
        self.Clothes_room_button = self.create_toggle_button("Door", resource_path("icons/icons-door.png"), 420, 240)
...
# زر تشغيل/إيقاف الكاميرا
        self.cameraButton = self.create_toggle_button("Camera", resource_path("icons/camera.png"), 20, 350)
...
#----------------------------------------------RadioPlayer_button---------------------------------------------------------------
        # زر تشغيل الراديو
        self.playButton = self.create_toggle_button("Radio", resource_path("icons/Play_Radio.png"),20,130)
        self.playButton.clicked.connect(self.toggleRadio)

     
        # زر إخفاء المتصفح
        self.hideButton = self.create_toggle_button("Hide Radio", resource_path("icons/Hide_Radio.png"),20,240)
